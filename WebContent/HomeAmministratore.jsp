...
<div class="navbar-inner">
  <img hspace="10px" style="width: 18%; height: 18%" alt="" src="img/logo-big.png">
...
<div class="container profile">
	...
	<form action=AggiungiTutor.jsp>
		<input  class=myButton type="submit" id="aggT" value="Aggiungi Tutor">
		<br>
	</form>
	</div>
	<div class=container style="padding:2%">
	<form action=RimuoviTutor.jsp>
		<input  class=myButton type="submit" id="rimT" value="Rimuovi Tutor">
	</form>
</div>
