...
<html lang="en">
<head>
<title>Richiedi Accompagnamento</title>
 <%@ page import="model.TutorBeanDao" %>
 <%@ page import="model.TutorBean" %>
 <%@ page import="model.AccompagnamentoBean" %>
  <%@ page import="model.AccompagnamentoBeanDao" %>
...
<script>
function check(){
  var ora=document.forms["RichiediAccompagnamento"]["ora"].value;
  return ((CheckOra(ora)));
}
...
<div class="container profile">
	...
	<script src="javascript/controlloForm.js" type="text/javascript"></script>
		<h2 style="font-size: 40px" id="titolo">Richiesta Accompagnamento</h2>
		<br>
		
		<form   action="RichiediAccompagnamento" method="post" onSubmit="check()" onReset="cancella()">
			...
			<label style="font-size: 30px" for=descrizione>	Descrizione:</label><input  type="text" name="descrizione" ><br>
